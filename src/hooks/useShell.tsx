...
export function useShell(params: {
  ...
  // 2) Submit handler (copy your existing logic from App.tsx here)
  ...
  if (
    ...
    // be sure to call setLsOutput(...) and setTextOutput(...), setError(...) just as you did
    // and at the end always call setInput("") to clear the prompt.

  // 3) Keyboard handler (arrow-up/down history, Tab autocomplete)
  ...
  // 4) Autocomplete effect (copy your existing useEffect from App.tsx here)
  useEffect(() => {
  ...
  return {
    ...
    handleShellSubmit,
    handleKeyDown,
    // and if you need the setters in App.tsx:
    setError,
    setLsOutput,
    setTextOutput,
    setLastCommand,
